        ...
        @if($options->type == 'belongsTo')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @php
                    ...
                    $query = $model::where([$options->key => $dataTypeContent->{$options->column}, 'author_id' => Auth::user()->id]})->first();
                    dd($query);
                @endphp
            ...
            @else
                ...
                >
                    @php
                        $model = app($options->model);
                        $query = $model::where([$options->key => $dataTypeContent->{$options->column}, 'author_id' => Auth::user()->id])->get();
                    @endphp
